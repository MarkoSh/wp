...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'company-elite' ),
	'priority'   => 100,
...
$wp_customize->add_section( 'section_header',
	array(
	'title'      => __( 'Header Options', 'company-elite' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
...
$wp_customize->add_control( 'theme_options[show_title]',
	array(
	'label'    => __( 'Show Site Title', 'company-elite' ),
...
$wp_customize->add_control( 'theme_options[show_tagline]',
	array(
	'label'    => __( 'Show Tagline', 'company-elite' ),
	'section'  => 'section_header',
	'type'     => 'checkbox',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[contact_email]',
	array(
	'label'    => __( 'Contact Email', 'company-elite' ),
	'section'  => 'section_header',
	'type'     => 'text',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[contact_number]',
	array(
	'label'    => __( 'Contact Number', 'company-elite' ),
	'section'  => 'section_header',
	'type'     => 'text',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[contact_address]',
	array(
	'label'    => __( 'Contact Address', 'company-elite' ),
	'section'  => 'section_header',
	'type'     => 'text',
	'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[show_social_in_header]',
	array(
		'label'    => __( 'Enable Social Icons', 'company-elite' ),
		'section'  => 'section_header',
		'type'     => 'checkbox',
		'priority' => 100,
	)
...
$wp_customize->add_control( 'theme_options[show_search_in_header]',
	array(
		'label'    => __( 'Enable Search Form', 'company-elite' ),
		'section'  => 'section_header',
		'type'     => 'checkbox',
		'priority' => 100,
	)
...
$wp_customize->add_section( 'section_layout',
	array(
	'title'      => __( 'Layout Options', 'company-elite' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'theme_options[site_layout]',
	array(
	'label'    => __( 'Site Layout', 'company-elite' ),
	'section'  => 'section_layout',
	'type'     => 'select',
	'choices'  => company_elite_get_site_layout_options(),
	'priority' => 100,
	)
);
...
$wp_customize->add_control( 'theme_options[global_layout]',
	array(
	'label'    => __( 'Global Layout', 'company-elite' ),
	'section'  => 'section_layout',
	'type'     => 'select',
	'choices'  => company_elite_get_global_layout_options(),
	'priority' => 100,
	)
);
...
$wp_customize->add_control( 'theme_options[archive_layout]',
	array(
	'label'    => __( 'Archive Layout', 'company-elite' ),
	'section'  => 'section_layout',
	'type'     => 'select',
	'choices'  => company_elite_get_archive_layout_options(),
	'priority' => 100,
	)
);
...
$wp_customize->add_section( 'section_footer',
	array(
	'title'      => __( 'Footer Options', 'company-elite' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_setting( 'theme_options[copyright_text]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'company_elite_sanitize_textarea',
	)
);
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'company-elite' ),
...
$wp_customize->add_section( 'section_blog',
	array(
	'title'      => __( 'Blog Options', 'company-elite' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'theme_options[blog_page_title]',
	array(
	'label'       => __( 'Blog Page Title', 'company-elite' ),
...
$wp_customize->add_setting( 'theme_options[excerpt_length]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'company_elite_sanitize_positive_integer',
	)
);
$wp_customize->add_control( 'theme_options[excerpt_length]',
	array(
	'label'       => __( 'Excerpt Length', 'company-elite' ),
	'description' => __( 'in words', 'company-elite' ),
	'section'     => 'section_blog',
	'type'        => 'number',
	'priority'    => 100,
...
$wp_customize->add_section( 'section_breadcrumb',
	array(
	'title'      => __( 'Breadcrumb Options', 'company-elite' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'theme_options[breadcrumb_type]',
	array(
	'label'       => __( 'Breadcrumb Type', 'company-elite' ),
	'section'     => 'section_breadcrumb',
	'type'        => 'select',
	'choices'     => company_elite_get_breadcrumb_type_options(),
	'priority'    => 100,
	)
);
