...
function customizer_library_sabino_options() {
    ...
    $options['sabino-unote-blog-list'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Set Blog List/Archive/Single pages to Left Sidebar<br />- Set Blog List/Archive/Single pages to Full Width<br />- Option to add Author Block to Blog single pages<br />- Display Blog list posts summary/excerpt/shortened content', 'sabino' )
    );
