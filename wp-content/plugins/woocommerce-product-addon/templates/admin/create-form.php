...
if (isset ( $_REQUEST ['productmeta_id'] ) && $_REQUEST ['do_meta'] == 'edit') {
	...
	$productmeta_id		= $_REQUEST ['productmeta_id'];
...
<input type="hidden" name="productmeta_id" value="<?php echo $productmeta_id?>">
...
<h2><a href="http://najeebmedia.com/wordpress-plugin/woocommerce-product-designer/">WooCommerce Simple Event Booking with Ticketsa</a></h2>
...
<h2><a href="http://najeebmedia.com/wordpress-plugin/woocommerce-product-designer/">Boost UP your WooCommerce Store Speed Upto 70%</a></h2>
